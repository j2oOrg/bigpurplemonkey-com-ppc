...
<head>
  ...
  <meta name="description" content="bigpurplemonkey — Licensed raffle with cash prizes, responsible play, and clear rules.">
...
<nav class="navbar navbar-expand-lg nav-rail-q5h8">
  <div class="shell-wrap-z4m2 d-flex align-items-center justify-content-between">
    ...
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navMenu" aria-controls="navMenu" aria-expanded="false" aria-label="<?php esc_attr_e('Toggle navigation', 'bigpurplemonkey'); ?>">
