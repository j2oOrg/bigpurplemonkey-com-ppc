  ...
  <section class="hero" id="home">
    <div class="container hero-grid">
      <div class="hero-copy">
        ...
        <p class="hero-sub" style="margin-top:0.8rem;">Operator / Licensee: bigpurplemonkey Association Foundation • Authority: Alberta Gaming, Liquor &amp; Cannabis (AGLC). bigpurplemonkey is the campaign/brand name only and is not the operator.</p>
      </div>
    ...
    <div class="container">
      ...
      <div class="rg-grid">
        <div class="rg-card">
          ...
          <p>Operator / Licensee: bigpurplemonkey Association Foundation • AGLC Raffle Licence #662961 • 995 tickets • $10 each • Draw: Feb 25, 2026 • One $3,780 winner.</p>
